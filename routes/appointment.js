...
router.post("/", middleware.isLoggedIn, function(req, res){
    ...
    Appointment.create(newDiscussion, function(err, newlyCreated){
        if(err){
            ...
            req.flash("success", "New Appointment Successfully Created")
...
//             res.redirect("back");
//         } else {
//         // another if statment to check if the user own the Appointment?
//           if(foundAppointment.author.id.equals(req.use._id)){
//                 next();
//           } else {
//                 res.redirect("back");
//           }
